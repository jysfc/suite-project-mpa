   ...
   return (
      <AppTemplate>
         ...
         >
            <div className="row">
               <div className="col-md-5 mt-2 crop">
                  <img src={MIRHOS} className="img-fluid" alt="MIRHOS" />
               </div>
               <div className="col-md-7">
                  <div className="text-muted">
                     <Link
                        ...
                        type="button"
                     >
                        <h2>Two Bedroom Hospitality Suite</h2>
                     </Link>
                     <p className="text-dark lead">The Mirage Hotel & Casino</p>
                     <p>1714 sq. ft · 6 max guests</p>
         ...
         >
            <div className="row">
               <div className="col-md-5 mt-2 crop">
                  <img src={MBPANO} className="img-fluid" alt="MBPANO" />
               </div>
               <div className="col-md-7">
                  <div className="text-muted">
                     <Link
                        ...
                        type="button"
                     >
                        <h2>Panoramic Two Bedroom Suite</h2>
                     </Link>
                     <p className="text-dark lead">
                        Mandalay Bay Hotel & Casino
                     </p>
                     <p>1450 sq. ft · 6 max guests</p>
                     <p>1 king bed · 2 queen beds</p>
                     <p className="card-text"></p>
                  </div>
               </div>
